...
<div className="min-h-screen bg-base-300 text-base-content p-6 lg:p-10 font-sans">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
    <div className="stat bg-base-100 rounded-box shadow-sm border border-base-200/60 py-4">
      ...
      <div className="stat-value text-primary text-3xl font-black">{sessions.length}</div>
    </div>
    ...
    <div className="stat bg-base-100 rounded-box shadow-sm border border-base-200/60 py-4">
      ...
      <div className="stat-value text-secondary text-3xl font-black">
        {new Set(sessions.map(s => s['reader-name'])).size}
      </div>
    </div>

    <div className="stat bg-base-100 rounded-box shadow-sm border border-base-200/60 py-4">
      <div className="stat-title text-base-content/70 font-semibold">Locations In Use</div>
      <div className="stat-value text-accent text-3xl font-black">
